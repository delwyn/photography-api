...
module.exports = [{
  ...
  id: 6,
  name: 'British Museum',
  description: 'This museum has some amazing architecture, so be sure to head inside even if you aren\'t really interested in any of the exhibitions. <P>After walking in the main entrance you will enter the Great Hall which has a beautiful roof designed by Norman Foster. You can get many great images looking up at this from letious parts of the hall. <P>If you come into the main entrance and go up some stairs on the left, instead of moving forward to the Great Hall, then you can get to a great viewing window which looks down on to the Great Hall itself (pictured here).<P>Then of course there are some good shots to be had at the exhibitions themselves, a particular favourite being the Egyptian Collection in wing 4 (left centre of the Great Hall). <P>No tripods are allowed within the museum or the grounds though in some areas of the grounds you can often get away with it when away from the regular flow of people.',
  lat: '51.518804',
  lng: '-0.126212',
  stationIds: [
    128,
